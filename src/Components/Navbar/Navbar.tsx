  ...
  return (
    <div className={Style["relative"]}>
      <Dock direction="middle" className={Style["dock"]}>
        <DockIcon className={Style["icons"]}>
          <a href="/">
        ...
        <DockIcon className={Style["icons"]}>
          <a href="https://github.com/hashir-deve" target="_blank">
            <Icons.gitHub className="size-6" />
          </a>
        </DockIcon>
        <DockIcon className={Style["icons"]}>
          <a
            href="https://www.linkedin.com/in/muhammad-hashir-aslam"
            target="_blank"
          >
            <Icons.linkedin className="size-6" />
          </a>
        </DockIcon>
        <DockIcon className={`${Style["icons"]} ${Style["icon-x"]}`}>
          <a href="https://x.com/HashDev200" target="_blank">
            <Icons.x className="size-6" />
          </a>
        </DockIcon>
        <DockIcon className={`${Style["icons"]} ${Style["icon-email"]}`}>
          <a href="mailto:hashdev200@gmail.com" target="_blank">
            <Icons.email className="size-6" color="#fff" />
          </a>
        </DockIcon>

        <Separator orientation="vertical" className="h-full sep" />
